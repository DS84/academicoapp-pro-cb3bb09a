...
('Metodologias Ativas de Ensino', 40, true, 'online', ARRAY['2024-02-15', '2024-03-15'], 15000, 'Formação em metodologias ativas e aprendizagem baseada em projetos'),
('Tecnologia na Educação', 30, true, 'hibrido', ARRAY['2024-02-20', '2024-03-20'], 12000, 'Integração de tecnologias digitais no processo de ensino-aprendizagem'),
('Avaliação Formativa', 25, true, 'presencial', ARRAY['2024-03-01', '2024-03-30'], 10000, 'Técnicas modernas de avaliação e feedback'),
('Co-docência e Trabalho Colaborativo', 35, true, 'online', ARRAY['2024-03-10', '2024-04-10'], 14000, 'Estratégias para ensino colaborativo entre docentes'),
('Gestão de Sala de Aula Digital', 20, false, 'online', ARRAY['2024-02-25'], 8000, 'Ferramentas e técnicas para gestão de ambientes virtuais de aprendizagem');
